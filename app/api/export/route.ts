...
<head>
  <meta charset="UTF-8">
  <title>Gaslighter Detect - Analysis Report</title>
  <style>
    body {
...
<body>
  <div class="header">
    <div class="logo">🛡️ Gaslighter Detect</div>
  ...
  <div class="footer">
    <p>Generated by Gaslighter Detect | Session ID: ${session.id}</p>
    ...
    if (format === 'html') {
      return new NextResponse(html, {
        headers: {
          ...
          'Content-Disposition': `attachment; filename="gaslighter-detect-report-${sessionId.slice(0, 8)}.html"`,
        },
      });
    }
